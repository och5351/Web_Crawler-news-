...
1. Connect Agent 기능
    1. 정해 놓은 검색엔진과 검색어의 검색 결과(URL) 수집.
    2. URL Response를 Collect Agent 로 전달.
    3. 처음 수집한 페이지 넘버를 확인 후 Queue 구성 후 Collect에 전달 받은 정보 비교 삽입
<br><br>

2. Collect Agent 기능
    1. Connect Agent 에게 넘겨 받은 URL Response의 HTML 수집.
    2. Connect Agent 에게 넘겨 받은 HTML 분석 후 페이지 넘버 추출 및 Connect에 전달
<br><br>

3. Save Agent 기능
    1. Collect Agent에서 수집한 HTML을 지정된 PC에 저장.
<br><br>
