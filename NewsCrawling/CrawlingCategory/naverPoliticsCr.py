...
class naverPoliticsCrawling:

    crawlingUtil = CrawUtil()

    def __init__(self, today, rootPath):

        path = rootPath + '/Politics'
        URL = 'https://news.naver.com/main/ranking/popularDay.nhn?rankingType=popular_day&sectionId=100&date=' + today
        ...
        for count in range(len(links)):
            ...
            if result_text == '':
                ...
                OUTPUT_FILE_NAME = 'Politics/Politics%05d.txt' % (count + fileNum - p)
