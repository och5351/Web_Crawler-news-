...
class naverWorldCrawling:
    ...
    def __init__(self, today, rootPath):
        ...
        path = rootPath + '/World'
        URL = 'https://news.naver.com/main/ranking/popularDay.nhn?rankingType=popular_day&sectionId=104&date=' + today
        ...
        for count in range(len(links)):
            ...
            if result_text == '':
                ...
                OUTPUT_FILE_NAME = 'World/World%05d.txt' % (count + fileNum - p)
